...
$string['jumboshowlogo'] = "Show Jumbotron Logo";
$string['jumboshowlogo_desc'] = "Toggles whether to display logo over banner";
$string['jumboshowtext'] = "Show Jumbotron Text";
$string['jumboshowtext_desc'] = "Toggles whether to display title, description overlay over banner.";
